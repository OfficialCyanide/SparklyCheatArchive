...
public:
	...
	{
		_ValveColor[0] = (unsigned char)_r;
		_ValveColor[1] = (unsigned char)_g;
		_ValveColor[2] = (unsigned char)_b;
		_ValveColor[3] = (unsigned char)_a;
	}
	...
	void SetRawValveColor(int ValveColor32)
	{
		*((int *)this) = ValveColor32;
	}
	...
	inline int r() const { return _ValveColor[0]; }
	inline int g() const { return _ValveColor[1]; }
	inline int b() const { return _ValveColor[2]; }
	inline int a() const { return _ValveColor[3]; }

	unsigned char &operator[](int index)
	{
		return _ValveColor[index];
	}
...
public:
	...
	ValveColor GetValveColor(const char *keyName = NULL /* default value is all black */);
	...
	ValveColor GetValveColor(int keySymbol /* default value is all black */);
	...
	void SetValveColor(const char *keyName, ValveColor value);
...
enum KeyValuesUnpackDestinationTypes_t
{
	...
	UNPACK_TYPE_VECTOR_ValveColor,								// dest is a vector, src is a ValveColor
...
inline ValveColor KeyValues::GetValveColor(int keySymbol)
{
	ValveColor defaultValue(0, 0, 0, 0);
	KeyValues *dat = FindKey(keySymbol);
	return dat ? dat->GetValveColor() : defaultValue;
}
