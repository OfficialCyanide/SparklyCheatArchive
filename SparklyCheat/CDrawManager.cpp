...
void CDrawManager::OutlineRect( int x, int y, int w, int h, DWORD dwColor )
{
	...
	//gInts.Surface->DrawFilledRect
}
//===================================================================================
void CDrawManager::DrawBox( Vector3 vOrigin, int r, int g, int b, int alpha, int box_width, int radius )
{
	Vector3 vScreen;
...
//===================================================================================
bool CDrawManager::WorldToScreen( Vector3 &vOrigin, Vector3 &vScreen )
{
