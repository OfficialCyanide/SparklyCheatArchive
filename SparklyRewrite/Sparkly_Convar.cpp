#include "Sparkly_Convar.h"
#include "Base.h"
#include "Sparkly_ICvar.h"
...
public:
	...
	{
		gBase.Cvar->RegisterConCommand(pVar);
		return true;
	}
};
...
{
	if (!gBase.Cvar || s_bRegistered)
		return;

	s_bRegistered = true;
	s_nCVarFlag = nCVarFlag;
	s_nDLLIdentifier = gBase.Cvar->AllocateDLLIdentifier();
